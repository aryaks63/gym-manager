            ...
            <div class="container">
               <table id="table" style="border=1px">
											...
											<tbody>
											   ...
											   $id=0;
											   $rr=$_SESSION['unam'];
											   $result113 = mysqli_query($con,"select * from member where unam = '$rr'") or die(mysqli_error($con)); 
            while($result223 = mysqli_fetch_array($result113)){
				$id=$result223['mid'];
			}
            $result11 = mysqli_query($con,"select * from schedule where mid='$id' ") or die(mysqli_error($con)); 
