                        ...
                        <div class="form-wrapper">
                            ...
                            <table id="table" style="border=1px">
											...
											<tbody>
											   <?php
			$user =$_SESSION['unam'];
			$result1 = mysqli_query($con,"select * from member where unam='$user'") or die(mysqli_error($con)); 
            if($result2 = mysqli_fetch_array($result1)){
				$mid = $result2['mid'];
			}								   											   
            $result11 = mysqli_query($con,"select * from schedule where mid='$mid'") or die(mysqli_error($con)); 
