...
<head>
	...
	<script>
        function getDet(id1){
          // var h = $('#hhh').val();
            $.get('ajax/getmemDet.php',{did :id1},function(data){
                $("#tablediv").html(data);
            });
        }
         ...
         $idd=$_POST['hdepid'];
           $a=$_POST['t1'];
            ...
            $g=$_POST['t7'];
                 ...
                 mysqli_query($con, "update member set fnam='$a',lnam='$b',address='$c',pin='$d',phone='$e',email='$f',age='$g' where mid='$idd'");
           echo "<script>alert('Updation sucess')</script>";
           }
                ...
                <div class="row justify-content-end">
                    <div class="col-xl-7 col-lg-7">
                        <div class="form-wrapper">
                            ...
                            <!--End Section Tittle  -->
                            <form id="contact-form" action="memEdit.php" method="POST">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
									<span><h2>Select Member</h2></span>
                                        <div class="form-box user-icon mb-30">
                                            <select name="t3" id="select2" onchange="getDet(this.value)">
